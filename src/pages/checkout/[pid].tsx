  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row justify-start md:justify-between mx-auto">
        ...
        >
          <div className="md:sticky top-6 left-0 w-full">
          ...
          >
            <div className="w-full md:w-[48%] flex flex-col">
              ...
              <div className="w-full flex flex-col">
                <h2 className="text-base tracking-wide mb-3">
                  SHIPPING DETAILS
                </h2>
                <AddressElement
              ...
              <div className="mb-6">
                ...
                {paymentMethod === "card" ? (
                  <div className="w-full">
                    <PaymentElement
                      className={classNames("w-full mb-3", spaceMono.className)}
                      options={{
                        wallets: {
                          applePay: "auto",
                        },
                    ...
                    />
                    <AltButton
                      className="w-full py-2 text-2xl font-bold mb-3"
