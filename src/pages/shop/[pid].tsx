  ...
  return (
    <main
      className={classNames(
        "w-full min-h-screen flex flex-col bg-skyBlue bg-dots-secondary py-10 px-3 sm:px-10 2xl:px-20",
        spaceMono.className
      )}
      style={{
    ...
    >
      <div className="relative w-full min-h-[85vh] flex justify-center pb-14">
          ...
          <div className="w-full h-fit max-w-3xl flex flex-col items-start justify-start lg:mr-[8%] mx-auto">
            ...
            <div className="w-full min-h-[250px] flex flex-col bg-lightGray border-2 border-primary shadow-block p-6 mb-2">
              ...
              <p className="font-bold text-sm">
                ...
                THOUGHT IT LOOKED INCREDIBLE. INDUSTRIES WITH LITTLE TO NO
                REGARD FOR AESTHETICS DESIGNING PEICES OF ART FOR UTILITARIAN
                PURPOSES CHURN OUT BANGERS LIKE NO ONE ELSE. WE&apos;VE
                COLLECTIVELY AESTHETICIZED GLASSES, BUT THE TREND OF STREET ART
                MAKING THE LEAP TO THE DIVINE SEEMS SO EASY. NO LONGER.
                LET&apos;S PUSH THE ENVELOPE ON WHAT ART IS; ART SHOULD BE
                ANYTHING THAT YOUR EYE GAZES UPON. MATERIALS/DETAILS: FLEXIBLE
                MOLDED CONSTRUCTION CYANOACRYLATE THIN SHEET MATERIAL THIN SHEET
                MATERIAL THIN SHEET MATERIAL
              </p>
            </div>
