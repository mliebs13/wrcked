                                    ...
                                    <div style="background-color: #34449a;height: 100%;width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_1" style="font-family:'Rubik',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 0px;font-family:'Rubik',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <strong>Hey Admin, We've received an order!</strong>
                                                            </h1>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 40px;font-family:'Rubik',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-family: 'courier new', courier; font-size: 18px; line-height: 25.2px;">Order ID: ${id}</span></strong>
                                                                </p>
                                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_5" style="font-family:'Rubik',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 10px 0px;font-family:'Rubik',sans-serif;"
                                                            align="left">
                                            ...
                                            <table id="u_content_heading_6" style="font-family:'Rubik',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 0px 10px;font-family:'Rubik',sans-serif;"
                                                            align="left">
  
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #ba372a; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: courier new,courier; font-size: 18px;">
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div
                                        ...
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="padding: 0px;border-top: 1px solid #CCC;border-left: 1px solid #CCC;
                                            border-right: 1px solid #CCC;border-bottom: 1px solid #CCC;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            <!--<![endif]-->
                                            ...
                                            <table style="font-family:'Rubik',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px;font-family:'Rubik',sans-serif;"
                                                            align="left">
  
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #ba372a; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: courier new,courier; font-size: 18px;">
                                                                ...
                                                                <a href="" target="_blank"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:15px 20px;line-height:120%;"><span
                                                                            style="font-family: 'courier new', courier; cursor: pointer; font-size: 18px; line-height: 21.6px;"><strong>Order
