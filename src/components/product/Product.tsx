      ...
      <div className="relative flex flex-col justify-start">
        {total >= 1 ? (
          <div className="w-full flex flex-col-reverse lg:flex-row min-h-fit lg:min-h-[500px] lg:h-[calc(94vh-var(--header-height))] pt-[calc(var(--box-height)/2)]">
            ...
            {/* more details */}
            <div className="w-full max-h-[420px] flex flex-col justify-end items-center self-end lg:min-w-[218px] 2xl:min-w-[258px] lg:w-[218px] 2xl:w-[258px] px-4 lg:mt-0 pt-4 pb-5">
